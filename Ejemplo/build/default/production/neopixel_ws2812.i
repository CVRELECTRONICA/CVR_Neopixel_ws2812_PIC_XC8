...
# 2 "<built-in>" 2
# 1 "neopixel_ws2812.c" 2
# 20 "neopixel_ws2812.c"
...
# 1 "./CVR_neopixel_ws2812.h" 1
# 11 "./CVR_neopixel_ws2812.h"
void neopixel_init();
...
void neopixel_turnOneLed(char index,char r, char g, char b){
    ...
    neopixel_offLeds(index-1,0);
    neopixel_setColor(r,g,b,1,1);
}
void neopixel_turnFromTo(char indexF,char indexT,char r, char g, char b){
    neopixel_offLeds(indexF - 1, 0);
    neopixel_setColor(r,g,b,indexT,1);
}
void neopixel_offLeds(char index,char reset){
...
void neopixel_setColor(char r, char g, char b,char numberOfLeds, char showChanges){
    for(char i =0; i < numberOfLeds; i++){
        ...
        for(char x =0; x<8; x++){
            if((val & 0x80) == 0){
                PORTBbits.RB0 = 1;
                _delay((unsigned long)((0.35)*(48000000/4000000.0)));
                PORTBbits.RB0 = 0;
                _delay((unsigned long)((0.8)*(48000000/4000000.0)));
            }else{
                PORTBbits.RB0 = 1;
                _delay((unsigned long)((0.7)*(48000000/4000000.0)));
                PORTBbits.RB0 = 0;
                _delay((unsigned long)((0.6)*(48000000/4000000.0)));
            }
            val = val << 1;
        }
        val = r;
...
void main(void) {
    while(1){
        ...
        for(char c =7; c>1;c--){
            ...
            neopixel_setColor(rv,gv,bv,1,1);
            _delay((unsigned long)((100)*(48000000/4000.0)));
        }
        ...
        for(char z=0; z<4;z++){
        neopixel_setColor(255,0,0,3,0);
        neopixel_setColor(133,44,121,2,0);
        neopixel_setColor(255,0,0,3,1);
        _delay((unsigned long)((200)*(48000000/4000.0)));

        neopixel_setColor(255,0,0,3,0);
        neopixel_setColor(0,0,0,2,0);
        neopixel_setColor(255,0,0,3,1);
        _delay((unsigned long)((200)*(48000000/4000.0)));
        }
